...
class QueueWorkerServiceCommand extends Command
{
    ...
    public function handle(): void
    {
        ...
        $serviceName = $this->option('service-name') ?? $this->ask('Queue worker service name', 'coramtix-queue');
...
After=redis-server.service' : '';
        ...
        $success = File::put($path, "# CoRamTix Queue File
# ----------------------------------

[Unit]
Description=CoRamTix Queue Service$afterRedis
