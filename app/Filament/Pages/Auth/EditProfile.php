                                    ...
                                    ->schema([
                                        ...
                                        Select::make('language')
                                            ...
                                            ->helperText(fn ($state, LanguageService $languageService) => new HtmlString($languageService->isLanguageTranslated($state) ? ''
                                                    : trans('profile.language_help', ['state' => $state]) . ' <u><a href="https://crowdin.com/project/coramtix-dev/">Update On Crowdin</a></u>'))
                                ...
                                Tab::make('2fa')
                                    ...
                                    ->schema(function (TwoFactorSetupService $setupService) {
                                        ...
                                        $options = new QROptions([
                                            'svgLogo' => public_path('coramtix.svg'),
                                            'svgLogoScale' => 0.05,
                                            'addLogoSpace' => true,
                                            'logoSpaceWidth' => 13,
                                            'logoSpaceHeight' => 13,
                                                ...
                                                Placeholder::make('font_preview')
                                                    ...
                                                    ->content(function (Get $get) {
                                                        ...
                                                        return new HtmlString(<<<HTML
                                                            ...
                                                            <span class="preview-text">The quick blue coramtix jumps over the lazy pterodactyl. :)</span>
                                                        HTML);
                                                    }),
