...
# CoRamTix Production Dockerfile
...
RUN chown root:www-data ./ \
    ...
    && mkdir -p /coramtix-data/storage /var/www/html/storage/app/public /var/run/supervisord /etc/supercronic \
    # Symlinks for env, database, and avatars
    && ln -s /coramtix-data/.env ./.env \
    && ln -s /coramtix-data/database/database.sqlite ./database/database.sqlite \
    && ln -sf /var/www/html/storage/app/public /var/www/html/public/storage \
    && ln -s  /coramtix-data/storage/avatars /var/www/html/storage/app/public/avatars \
    && ln -s  /coramtix-data/storage/fonts /var/www/html/storage/app/public/fonts \
    # Allow www-data write permissions where necessary
    && chown -R www-data:www-data /coramtix-data ./storage ./bootstrap/cache /var/run/supervisord /var/www/html/public/storage \
    && chmod -R u+rwX,g+rwX,o-rwx /coramtix-data ./storage ./bootstrap/cache /var/run/supervisord \
