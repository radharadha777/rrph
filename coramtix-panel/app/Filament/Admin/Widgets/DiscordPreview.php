    ...
    public function getViewData(): array
    {
        if (!$this->record || !$this->record->payload) {
            return [
                ...
                'sender' => [
                    'name' => 'CoRamTix',
                    'avatar' => 'https://raw.githubusercontent.com/coramtix-dev/panel/refs/heads/main/public/coramtix.ico',
                ],
                'embeds' => [],
        ...
        return [
            ...
            'sender' => [
                'name' => data_get($payload, 'username', 'CoRamTix'),
                'avatar' => data_get($payload, 'avatar_url', 'https://raw.githubusercontent.com/coramtix-dev/panel/refs/heads/main/public/coramtix.ico'),
            ],
            'embeds' => $embeds,
            'getTime' => 'Today at ' . Carbon::now()->format('h:i A'),
        ];
