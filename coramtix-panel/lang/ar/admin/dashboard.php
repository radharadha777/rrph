...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'إذا واجهت أي مشاكل، يرجى الإبلاغ عنها على GitHub.',
            'button_label' => 'إنشاء العقدة الأولى في CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'دعم CoRamTix',
            'content' => 'شكرًا لاستخدامك CoRamTix، لقد تحقق هذا بفضل دعمك، ودعم المساهمين، وبقية داعمينا!',
