...
return [
    'heading' => 'Сардэчна запрашаем у CoRamTix!',
...
',
        ...
        'intro-first-node' => [
            ...
            'button_label' => 'Стварыце першы вузел у CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Падтрымка CoRamTix',
            'content' => 'Дзякуй за выкарыстанне CoRamTix! Гэта стала магчымым толькі дзякуючы падтрымцы вас, нашых удзельнікаў і ўсіх астатніх, хто нас падтрымлівае!',
