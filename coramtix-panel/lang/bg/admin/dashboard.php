...
return [
    'heading' => 'Добре дошъл в CoRamTix!',
    ...
    'sections' => [
        ...
        'intro-no-update' => [
            ...
            'content' => 'Използвате CoRamTix версия :version. Вашият панел е актуален!',
        ],
        'intro-first-node' => [
            ...
            'extra_note' => 'Ако намерите някакви проблеми моля, докладвайте ги в GitHub.',
            'button_label' => 'Създай първия си Node в CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Подкрепете CoRamTix',
            'content' => 'Благодарим ви че използваш CoRamTix, Това можеше да се случи само чрез твойта подкрепа, на нашите сътрудници и останалите ни поддръжници!',
