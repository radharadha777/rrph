...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'button_label' => 'Vytvořte první Node v CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Podpořte CoRamTix!',
            'content' => 'Děkujeme za používání CoRamTix, toto je možné vytvářet jen díky vaší podpoře, přespěvatelům a dalším podporovatelům!',
