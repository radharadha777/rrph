...
return [
    ...
    'sections' => [
        ...
        'intro-no-update' => [
            ...
            'content' => 'Estás ejecutando la versión :version de CoRamTix. ¡Tu panel está actualizado!',
        ],
        'intro-first-node' => [
            ...
            'extra_note' => 'Si encuentra algún problema, por favor repórtelos en GitHub.',
            'button_label' => 'Crear el primer nodo en CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Apoyar a CoRamTix',
            'content' => '¡Gracias por usar CoRamTix! Esto solo ha sido posible gracias a ti, nuestros colaboradores y el resto de nuestros seguidores.',
