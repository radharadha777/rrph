...
return [
    'heading' => 'Selamat datang di CoRamTix Panel!',
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Jika terjadi error atau bermasalah, laporkan hal itu ke GitHub',
            'button_label' => 'Membuat Node pertama di CoRamTix Panel.',
        ],
        'intro-support' => [
            'heading' => 'Bantuan CoRamTix.',
            'content' => 'Terima kasih telah menggunakan CoRamTix, ini bisa dicapai dengan dukungan Anda, kontribusi kami, dan pendukung lainnya!',
