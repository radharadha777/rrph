...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'もし問題が発生した場合は、GitHubでご報告ください。',
            'button_label' => 'CoRamTixで最初のノードを作成',
        ],
        'intro-support' => [
            'heading' => 'CoRamTix をサポート',
            'content' => 'CoRamTixをご利用いただき、ありがとうございます。これは、皆様、貢献者の皆様、そしてその他のサポーターの皆様のご支援のおかげで実現できたものです！',
