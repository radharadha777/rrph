...
return [
    ...
    'sections' => [
        ...
        'intro-no-update' => [
            ...
            'content' => 'Używasz CoRamTix w wersji :version. Twój panel jest aktualny!',
        ],
        'intro-first-node' => [
            ...
            'extra_note' => 'Jeśli napotkasz jakieś problemy, zgłoś je na GitHubie.',
            'button_label' => 'Stwórz pierwszy węzeł w CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Wspomóż CoRamTix',
            'content' => 'Dziękujemy za korzystanie z CoRamTix, jest to możliwe jedynie dzięki waszemu wsparciu, naszym współtwórcom i pozostałym naszym zwolennikom!',
