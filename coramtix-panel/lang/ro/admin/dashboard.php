...
return [
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Dacă întâmpinați orice probleme, vă rugăm să le raportați pe GitHub.',
            'button_label' => 'Crează primul nod în CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Susține CoRamTix',
            'content' => 'Vă mulţumim că utilizaţi CoRamTix, acest lucru poate fi realizat doar prin sprijinul dumneavoastră, al contribuitorilor noştri şi al celorlalţi susţinători ai noştri!',
