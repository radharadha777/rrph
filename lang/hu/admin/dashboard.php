...
return [
    'heading' => 'Üdvözöljük a CoRamTixban!',
    ...
    'sections' => [
        ...
        'intro-no-update' => [
            ...
            'content' => 'A CoRamTixod :version verzióját futtatja. A paneled naprakész!',
        ],
        'intro-first-node' => [
            ...
            'extra_note' => 'Ha bármilyen problémába ütközik, kérjük jelentse a GitHubon.',
            'button_label' => 'Első csomópont létrehozása a CoRamTixban',
        ],
        'intro-support' => [
            'heading' => 'CoRamTix támogatása',
            'content' => 'Köszönjük, hogy használja a CoRamTixt, ezt csak az Ön és a támogatóink segítségével tudtuk elérni!',
