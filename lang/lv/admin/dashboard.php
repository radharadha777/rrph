...
return [
    'heading' => 'Laipni lūdzam CoRamTix!',
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Ja rodas problēmas, lūdzu, ziņojiet par tām vietnē GitHub.',
            'button_label' => 'Izveido savu pirmo starpniekserveri iekš CoRamTix!',
        ],
        'intro-support' => [
            'heading' => 'Atbalstīt CoRamTix',
            'content' => 'Paldies, ka izmantojāt CoRamTix. To var panākt tikai ar jūsu, mūsu līdzstrādnieku un pārējo mūsu atbalstītāju atbalstu!',
