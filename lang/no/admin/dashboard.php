...
return [
    'heading' => 'Velkommen til CoRamTix!',
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Hvis du støter på problemer, vennligst rapporter dem på GitHub.',
            'button_label' => 'Opprett første node i CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Støtt CoRamTix',
            'content' => 'Takk for at du bruker CoRamTix! Dette har kun vært mulig gjennom støtten fra deg, våre bidragsytere og resten av våre støttespillere!',
