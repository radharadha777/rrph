...
return [
    'heading' => 'Bem-vindo(a) ao CoRamTix!',
    ...
    'sections' => [
        ...
        'intro-first-node' => [
            ...
            'extra_note' => 'Se tiver algum problema, por favor reporte-o no GitHub.',
            'button_label' => 'Crie o primeiro Nó no CoRamTix',
        ],
        'intro-support' => [
            'heading' => 'Apoie o CoRamTix',
            'content' => 'Obrigado por utilizarem o CoRamTix, isto só foi possível com o vosso apoio, dos nossos colaboradores e dos restantes apoiantes!',
